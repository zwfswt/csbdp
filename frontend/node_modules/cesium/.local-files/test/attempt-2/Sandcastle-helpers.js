(function () {
  ...
  window.embedInSandcastleTemplate = function (code, addExtraLine) {
    return (
      ...
      "const importRule = [...document.styleSheets].find(sheet => sheet.rules[0] instanceof CSSImportRule);\n" +
      `//console.log(document.styleSheets);\n` +
      `console.log(importRule?.cssRules);\n` +
      `console.log(importRule?.cssRules[0]?.styleSheet?.cssRules);\n` +
      `};\n` +
