 ...
 */
export declare function isControlChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isAsciiLetterChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isDigitChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isQuoteChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isWhitespaceChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isAlphaNumericOrMarkChar(c: number): boolean;
/**
 ...
 *     npm run generate-char-utils
 */
export declare function isValidEmailLocalPartSpecialChar(c: number): boolean;
/**
 * Determines if the given character `c` matches the regular expression /[-+&@#/%=~_()|'$*[\]{}\u2713]/
 * by checking it via character code in a binary search fashion.
 *
 ...
 *     npm run generate-char-utils
 */
export declare function isUrlSuffixAllowedSpecialChar(c: number): boolean;
/**
 * Determines if the given character `c` matches the regular expression /[?!:,.;^]/
 * by checking it via character code in a binary search fashion.
 *
 ...
 *     npm run generate-char-utils
 */
export declare function isUrlSuffixNotAllowedAsFinalChar(c: number): boolean;
/**
 * Determines if the given character `c` matches the regular expression /[({[]/
 * by checking it via character code in a binary search fashion.
 *
 ...
 *     npm run generate-char-utils
 */
export declare function isOpenBraceChar(c: number): boolean;
/**
 * Determines if the given character `c` matches the regular expression /[)}\]]/
 * by checking it via character code in a binary search fashion.
 *
 ...
 *     npm run generate-char-utils
 */
export declare function isCloseBraceChar(c: number): boolean;
